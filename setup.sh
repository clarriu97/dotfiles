...
# distro selection
echo -e "\n${white}What distro are you using?${nc}"
...
function configure_ubuntu_terminal {
    echo -e "\n${orange}Installing ${green}kitty${orange}...${nc}" && \
    sudo add-apt-repository universe && \
    sudo apt update -y && \
    sudo apt install -y kitty && \
    echo -e "${green}kitty${orange} installed!${nc}" && \

    echo -e "\n${orange}Installing ${green}tldr${orange}...${nc}" && \
    sudo apt install -y tldr && \
    echo -e "${green}tldr${orange} installed!${nc}" && \

    echo -e "\n${orange}Installing ${green}lsd${orange}...${nc}" && \
    ...
    echo -e "\n${orange}Installing ${green}bat${orange}...${nc}" && \
    ...
    echo -e "\n${orange}Installing ${green}fzf${orange}...${nc}" && \
...
function install_hack_nerd_font {
    echo -e "\n${orange}Installing ${green}HackNerdFont${orange}...${nc}" && \
